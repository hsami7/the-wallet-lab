...
export default function Home() {
  return (
    <>
      <section className="relative px-6 lg:px-20 py-16 lg:py-24 @container">
        <div className="flex flex-col lg:flex-row items-center gap-12 max-w-7xl mx-auto">
          <div className="flex flex-col gap-8 flex-1">
            ...
            <h1 className="text-slate-100 text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight">
          ...
          <div className="flex-1 relative w-full aspect-square lg:aspect-auto">
            ...
            <div className="relative w-full h-[400px] lg:h-[600px] bg-slate-900 rounded-xl border border-slate-800 shadow-2xl overflow-hidden group">
              ...
              />
              <div className="absolute bottom-6 left-6 right-6 p-6 rounded-xl bg-slate-950/60 backdrop-blur-md border border-white/10">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-primary text-xs font-bold uppercase tracking-widest">Premium Edition</p>
                    <h3 className="text-xl font-bold text-white">Carbon-X Phantom</h3>
                  </div>
      ...
      <section className="px-6 lg:px-20 py-20 bg-slate-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="flex flex-col gap-2">
              <h2 className="text-3xl font-bold text-white tracking-tight">The Lab Selection</h2>
              <p className="text-slate-400">Precision machined for maximum utility.</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group flex flex-col gap-6 p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 hover:border-primary/50 transition-all">
              <div className="aspect-[4/5] overflow-hidden rounded-lg bg-slate-900">
                <img 
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="text-lg font-bold text-white">Leather Pro Slim</h4>
                    <p className="text-sm text-slate-500">Italian Full Grain</p>
                  </div>
                  <span className="text-lg font-bold text-primary">$85</span>
                </div>
                <button className="w-full py-3 bg-slate-700 hover:bg-primary text-white font-bold rounded-full transition-colors text-sm">
                  Add to Cart
                </button>
              </div>
            </div>
            ...
            <div className="group flex flex-col gap-6 p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 hover:border-primary/50 transition-all">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="text-lg font-bold text-white">Nomad Carbon</h4>
            ...
            <div className="group flex flex-col gap-6 p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 hover:border-primary/50 transition-all">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h4 className="text-lg font-bold text-white">Titan Bifold</h4>
      ...
      <section className="px-6 lg:px-20 py-20 bg-primary/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 grid grid-cols-2 gap-4">
            <div className="p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 flex flex-col gap-4">
              <span className="material-symbols-outlined text-primary text-3xl">shield</span>
              <h3 className="font-bold text-white text-lg leading-tight">Military Grade Shielding</h3>
            ...
            <div className="p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 flex flex-col gap-4">
              ...
              <h3 className="font-bold text-white text-lg leading-tight">Quick Access Trigger</h3>
            ...
            <div className="p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 flex flex-col gap-4">
              ...
              <h3 className="font-bold text-white text-lg leading-tight">Ultra Slim Profile</h3>
            ...
            <div className="p-6 rounded-xl bg-slate-800/40 border border-slate-700/50 flex flex-col gap-4">
              ...
              <h3 className="font-bold text-white text-lg leading-tight">Lifetime Warranty</h3>
              <p className="text-sm text-slate-500">Engineered to last through generations.</p>
            </div>
          </div>
          <div className="flex-1 flex flex-col gap-8">
            <h2 className="text-4xl font-bold text-white leading-tight">Built for the <br /><span className="text-primary italic">Digital Frontier</span></h2>
      ...
      <section className="px-6 lg:px-20 py-24">
        <div className="max-w-5xl mx-auto rounded-xl p-10 lg:p-20 bg-slate-800 relative overflow-hidden text-center flex flex-col items-center gap-8 border border-slate-700/50">
          <div className="absolute inset-0 carbon-pattern opacity-10"></div>
          <div className="relative z-10 flex flex-col gap-4 items-center">
            <span className="material-symbols-outlined text-primary text-5xl">alternate_email</span>
          ...
          <form className="relative z-10 flex flex-col sm:flex-row gap-4 w-full max-w-md">
            <input className="flex-1 bg-slate-900 border-slate-700 rounded-full px-6 py-4 focus:border-primary focus:ring-1 focus:ring-primary text-white outline-none placeholder:text-slate-500" placeholder="Enter your email" required type="email" />
            <button className="bg-primary hover:bg-primary/80 text-white font-bold px-8 py-4 rounded-full transition-all" type="submit">
              Subscribe
            </button>
          </form>
          <p className="relative z-10 text-xs text-slate-500">By joining, you agree to our Terms and Privacy Policy. No spam, just tech.</p>
        </div>
      </section>
    </>
  );
