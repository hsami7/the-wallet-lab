...
export default function NotFound() {
  return (
    <div className="flex flex-col min-h-[70vh] items-center justify-center bg-slate-50 dark:bg-[#0F172A] relative overflow-hidden px-6 transition-colors duration-500 rounded-3xl my-8">
