      ...
      <div className="w-full max-w-[480px] bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl p-8 rounded-lg border border-slate-200 dark:border-slate-800 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400">
            {mode === "signin" ? "Securely access your digital assets" : mode === "signup" ? "Join the inner circle of secure carry" : "Enter your email to receive a reset link"}
          </p>
        </div>
        ...
        <form action={mode === "signin" ? login : mode === "signup" ? signup : forgotPassword} className="space-y-5">
          {mode === "signup" && (
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-8">
          ...
          <button type="button" onClick={() => { setMode(mode === "forgot" ? "signin" : (mode === "signin" ? "signup" : "signin")); setError(null); }} className="text-primary font-semibold hover:underline ml-1">
