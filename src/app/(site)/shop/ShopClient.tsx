            ...
            <Link key={product.id} href={`/product/${product.slug}`} className="group relative flex flex-col bg-white dark:bg-slate-900/50 rounded-xl overflow-hidden border border-slate-200 dark:border-primary/10 hover:border-primary transition-all duration-300">
              <div className="relative aspect-square overflow-hidden bg-slate-100 dark:bg-slate-800">
                ...
                <button 
                  ...
                  className="absolute bottom-4 right-4 size-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity"
                >
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <button 
                  ...
                  className="mt-auto w-full py-3 bg-primary hover:bg-blue-600 text-white font-bold rounded-lg shadow-[0_0_20px_rgba(13,89,242,0.3)] transition-all flex items-center justify-center gap-2"
                >
