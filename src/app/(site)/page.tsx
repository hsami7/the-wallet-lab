...
export default async function Home() {
  ...
  const defaultCollections = [
    { label: 'Everyday Essentials', heading: 'Classic style', image_url: '/collections/classic.png', button_text: 'Shop Now', button_link: '/shop', is_slider: false },
    { label: 'Winter Collection', heading: 'Cozy looks for any season', image_url: '/collections/winter.png', button_text: 'Discover more', button_link: '/shop', is_slider: false },
    { label: 'Premium Accessories', heading: 'Timeless accessory', image_url: '/collections/accessories.png', button_text: 'Shop Now', button_link: '/shop', is_slider: false },
  ];
